...
//  Export/Import symbol macro for MSVC:
//  If QUAZIP_COMPILE_LIBRARY is defined in the pro file: a dll is built.
//     --> QUAZIP_USE_LIBRARY is required in project that depnds on the dll

#if defined(QUAZIP_COMPILE_LIBRARY)
#define QUAZIP_EXPORT Q_DECL_EXPORT
#elif defined(QUAZIP_USE_LIBRARY)
